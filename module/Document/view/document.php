...
<head>
	<title><?php echo $options['title']; ?> - Powered by Ahoy World</title>
			...
			<div class="navbar-inner">
				<div class="container">
					...
					<p class="navbar-text pull-right">
						Created by <a href="http://www.twitter.com/atticjack">Rarek</a>, Founder of <a href="http://www.ahoyworld.co.uk/">Ahoy World</a>
					</p>
				</div>
			</div>
		</div>
