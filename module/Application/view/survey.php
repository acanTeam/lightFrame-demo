...
<div class="wrapper " id="survey-page">
  <div class="page">
    <form method="POST" name="answer" action="<?php echo $application->domain; ?>lbs/answer" id="answer">
      <div data-mandatory="0" data-type="98" id="5f94ea4c5755935662d03ca5c2e5ff41" class="question">
        <div class="question-answer">
          <div class="answer-text clearfix">
            ...
            4.  该调查主要涉及地图APP30个方面的需求<br />
            5.  针对每个需求，你将要回答两个方面的问题：<br />
            <li>一是当一个需求实现时，你认为如何</li>
            <li>一是当一个需求不被实现时，你认为如何</li>
            6.  针对每个问题，你有五种可选的答案：<br />
            <li>A.  我觉得很好 /你对当前问题的内容持肯定、欢迎态度</li>
            <li>B.  这是必须的  /你认为当前问题的内容是理所当然的</li>
            <li>C.  不知道  /你认为当前问题的内容好坏都可以，无关紧要</li>
            <li>D.  也可以/你觉得当前问题的内容你不太欢迎，但也可以接受</li>
            <li>E.  我觉得不好/你觉得当前问题的内容如果出现了你无法接受</li>
            7.  特别提醒，你在回答问题时，由于每个需求所提出的两个问题都是一样的，因此你只需要了解每一个需求的内容，而无需关注问题的具体内容。<br />
          </div>
        </div>
      </div>
      ...
      <div data-mandatory="1" data-type="4" id="<?php echo 'baseQuestion_' . $i; ?>" class="question">
        <div class="question-title" data-original-title="" title="">
          ...
          <div class="question-text clearfix"><?php echo $question['title']; ?></div>
        </div>
      ...
      <div data-direction="X" data-mandatory="1" data-type="5" id="<?php echo 'question_' . $i; ?>" class="question">
        <div class="question-title">
          <div class="question-code">Q<?php echo $i; ?>.</div>
          <div class="question-text clearfix">【<?php echo $question['title']; ?>】 需求说明：<?php echo $question['description']; ?></div>
        </div>
        <div class="question-answer">
          <table class="answer-table">
            <tbody>
              ...
              <tr data-group="<?php echo $elem; ?>" data-mandatory="1">
                <?php $titleInfo = $elem == $haveCode ? '<td data-child="1"><div class="table-question-text">如果实现这个需求，你感觉如何？</div></td>' : '<td data-child="2"><div class="table-question-text">如果不实现这个需求，你感觉如何？</div></td>'; echo $titleInfo; ?>
                <?php for ($j = 1; $j < 6; $j++) { ?>
                <td>
